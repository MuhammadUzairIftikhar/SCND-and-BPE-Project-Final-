...
public class ProductServiceLocator extends org.apache.axis.client.Service implements main.ProductService {
    ...
    private java.lang.String Product_address = "http://localhost:8080/GrocerySystem/services/Product";
    ...
    public main.Product getProduct(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.ProductSoapBindingStub _stub = new main.ProductSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Product.class.isAssignableFrom(serviceEndpointInterface)) {
                main.ProductSoapBindingStub _stub = new main.ProductSoapBindingStub(new java.net.URL(Product_address), this);
                _stub.setPortName(getProductWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "ProductService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "Product"));
        }
